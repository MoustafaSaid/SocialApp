      ...
      return Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 5.0,),
            Text(
              '${userModel.name}',style: Theme.of(context).textTheme.bodyText1,),
            Text(
                    ...
                    child: InkWell(
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Post',style: Theme.of(context).textTheme.caption,),
                        ],
                      ),
                      onTap: (){},
                    ),
                  ...
                  Expanded(
                    child: InkWell(
                      child: Column(
                        children: [
                          Text(
                            '254',style: Theme.of(context).textTheme.subtitle2,),
                          Text(
                      ...
                      child: Column(
                        children: [
                          Text(
                            '100',style: Theme.of(context).textTheme.subtitle2,),
                          Text(
                            'Followings',style: Theme.of(context).textTheme.caption,),
                        ],
                      ),
                      onTap: (){},
                    ),
